...
<<<<<<< HEAD:source/pdf-tool/bin/pdf-tool
listOfParamsAction=("--extract" "--number" "--concat" "--compress" "--rotate" \
    "--include" "--exclude" "--doc" "--help" "--version")
=======
listOfParamsAction=("--extract" "--number" "--concat" "--compress" "--rotate" "--include" "--exclude" "--doc" "--help")
>>>>>>> 2e5e26fd01d02ca35b4b8061c72d670822fa0611:source/pdf-tool/bin/pdf-tool.sh
...
=======
        echo -e "\e[1;091mOups !\e[0m The encoded value referring to the destination pdf file is equal to "
>>>>>>> 2e5e26fd01d02ca35b4b8061c72d670822fa0611:source/pdf-tool/bin/pdf-tool.sh
        echo -e "the number of pages that the latter has 🧐 "
        echo ""
