...
:   ' 
    ...
    *
    *
    * @requires The only options supported are [ self-update, self-upgrade, self-remove, install, update, 
    *                                            upgrade, remove, download, list, list-installed, search, 
    ...
    * && with the options [ self-update, self-upgrade, self-remove, update, list, list-installed, --help, 
    ...
    *                                Ex : meo self-update
    *
    * @param {string} self-upgrade // This option allows upgrading `meo` program
    *                                 Ex : meo self-upgrade
    * 
...
listOfParams=("self-update" "self-upgrade" "self-remove" "install" "update" "upgrade" "remove" "download" \
